"""
Custom integration to integrate oversight_android_tv_notifications with Home Assistant.

For more details about this integration, please refer to
https://github.com/evil-dog/ha-oversight-integration
"""
...
from .data import OversightAndroidTvNotificationsData
...
async def async_setup_entry(
    ...
    entry.runtime_data = OversightAndroidTvNotificationsData(
