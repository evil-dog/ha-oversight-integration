"""Sensor platform for oversight_android_tv_notifications."""
...
async def async_setup_entry(
    ...
    async_add_entities(
        OversightAndroidTvNotificationsSensor(
...
class OversightAndroidTvNotificationsSensor(OversightAndroidTvNotificationsEntity, SensorEntity):
    """oversight_android_tv_notifications Sensor class."""
